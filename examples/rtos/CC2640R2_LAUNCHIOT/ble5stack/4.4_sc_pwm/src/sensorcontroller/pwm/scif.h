/** \mainpage Driver Overview
  ...
  * Studio tool:
  * - <b>Project name</b>:     pwm for launchpad
  * - <b>Project file</b>:     C:/Users/chenfei/Documents/Texas Instruments/Sensor Controller Studio/examples/scs_pwm/pwm_for_launchpad.scp
  * - <b>Code prefix</b>:      -
  ...
  * - <b>Created</b>:          2017-11-27 10:04:00.043
  ...
  *
  *
  * \subsection section_task_desc_pwm_for_launchpad pwm for launchpad
  * No description entered
  *
  */
...
/// pwm for launchpad: Task ID
#define SCIF_PWM_FOR_LAUNCHPAD_TASK_ID 0


/// pwm for launchpad I/O mapping: RGBLEDCONTROL
#define SCIF_PWM_FOR_LAUNCHPAD_DIO_O_PWM_CTRL 6
...
/// pwm for launchpad: Task input data structure
typedef struct {
    uint16_t highdutycycle; ///< 
    uint16_t lowdutycycle;  ///< 
    uint16_t startFlag;     ///< 
} SCIF_PWM_FOR_LAUNCHPAD_INPUT_T;


/// pwm for launchpad: Task state structure
typedef struct {
    uint16_t exit; ///< 
} SCIF_PWM_FOR_LAUNCHPAD_STATE_T;


/// Sensor Controller task data (configuration, input buffer(s), output buffer(s) and internal state)
typedef struct {
    struct {
        SCIF_PWM_FOR_LAUNCHPAD_INPUT_T input;
        SCIF_PWM_FOR_LAUNCHPAD_STATE_T state;
    } pwmForLaunchpad;
} SCIF_TASK_DATA_T;
