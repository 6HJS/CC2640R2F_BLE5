/** \mainpage Driver Overview
  ...
  * Studio tool:
  * - <b>Project name</b>:     I2C for LaunchPad
  * - <b>Project file</b>:     C:/Users/chenfei/Documents/Texas Instruments/Sensor Controller Studio/examples/i2c_launchpad/uart_emulator_launchpad.scp
  * - <b>Code prefix</b>:      -
  ...
  * - <b>Created</b>:          2017-11-24 11:56:58.973
  ...
  *
  *
  * \subsection section_task_desc_i2c_bma250e I2C BMA250E
...
/// I2C BMA250E: Task ID
#define SCIF_I2C_BMA250E_TASK_ID 0


/// I2C BMA250E: 
#define SCIF_I2C_BMA250E_BMA250E_ADDR 24
/// I2C BMA250E: 
#define SCIF_I2C_BMA250E_BMA250E_BW 16
/// I2C BMA250E: 
#define SCIF_I2C_BMA250E_BMA250E_RANGE 3
/// I2C BMA250E: 
#define SCIF_I2C_BMA250E_BMA250E_REG_BW 16
/// I2C BMA250E: 
#define SCIF_I2C_BMA250E_BMA250E_REG_ID 0
/// I2C BMA250E: 
#define SCIF_I2C_BMA250E_BMA250E_REG_RANGE 15
/// I2C BMA250E: 
#define SCIF_I2C_BMA250E_BMA250E_REG_XYZ 2
/// I2C BMA250E: 
#define SCIF_I2C_BMA250E_BUFSIZE 10
/// I2C BMA250E I/O mapping: I2C SCL
#define SCIF_I2C_BMA250E_DIO_I2C_SCL 4
/// I2C BMA250E I/O mapping: I2C SDA
#define SCIF_I2C_BMA250E_DIO_I2C_SDA 5
...
/// I2C BMA250E: Task configuration structure
typedef struct {
    uint16_t bma250eid; ///< 
} SCIF_I2C_BMA250E_CFG_T;


/// I2C BMA250E: Task output data structure
typedef struct {
    uint16_t positionBuf[10]; ///< 
} SCIF_I2C_BMA250E_OUTPUT_T;


/// I2C BMA250E: Task state structure
typedef struct {
    uint16_t i2cStatus; ///< I2C master status
} SCIF_I2C_BMA250E_STATE_T;


/// Sensor Controller task data (configuration, input buffer(s), output buffer(s) and internal state)
typedef struct {
    struct {
        SCIF_I2C_BMA250E_CFG_T cfg;
        SCIF_I2C_BMA250E_OUTPUT_T output;
        SCIF_I2C_BMA250E_STATE_T state;
    } i2cBma250e;
} SCIF_TASK_DATA_T;
