/** \mainpage Driver Overview
  ...
  * Studio tool:
  * - <b>Project name</b>:     spi for launchpad
  * - <b>Project file</b>:     C:/Users/chenfei/Documents/Texas Instruments/Sensor Controller Studio/examples/scs_spi/spi_for_launchpad.scp
  * - <b>Code prefix</b>:      -
  ...
  * - <b>Created</b>:          2017-11-27 11:58:25.612
  ...
  * - spi for launchpad:
  *     - <b>SPI CSN: Flash CSN Pin</b>: DIO24
  *     - <b>SPI MISO</b>: DIO27
  *     - <b>SPI MOSI</b>: DIO26
  *     - <b>SPI SCLK</b>: DIO25
  *
  ...
  *
  *
  * \subsection section_task_desc_spi_for_launchpad spi for launchpad
  * No description entered
  *
  */
...
/// spi for launchpad: Task ID
#define SCIF_SPI_FOR_LAUNCHPAD_TASK_ID 0


/// spi for launchpad I/O mapping: Flash CSN Pin
#define SCIF_SPI_FOR_LAUNCHPAD_DIO_SPI_CSN_FLASH_CSN 24
/// spi for launchpad I/O mapping: SPI MISO
#define SCIF_SPI_FOR_LAUNCHPAD_DIO_SPI_MISO 27
/// spi for launchpad I/O mapping: SPI MOSI
#define SCIF_SPI_FOR_LAUNCHPAD_DIO_SPI_MOSI 26
/// spi for launchpad I/O mapping: SPI SCLK
#define SCIF_SPI_FOR_LAUNCHPAD_DIO_SPI_SCLK 25
...
/// spi for launchpad: Task output data structure
typedef struct {
    uint16_t DeviceID;       ///< 
    uint16_t ManufacturerID; ///< 
} SCIF_SPI_FOR_LAUNCHPAD_OUTPUT_T;


/// Sensor Controller task data (configuration, input buffer(s), output buffer(s) and internal state)
typedef struct {
    struct {
        SCIF_SPI_FOR_LAUNCHPAD_OUTPUT_T output;
    } spiForLaunchpad;
} SCIF_TASK_DATA_T;
