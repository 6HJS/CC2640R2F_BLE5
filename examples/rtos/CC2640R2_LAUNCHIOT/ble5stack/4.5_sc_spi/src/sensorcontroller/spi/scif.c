...
static const uint16_t pAuxRamImage[] = {
    ...
    /*0x00C0*/ 0x6436, 0xBDB7, 0x241A, 0xA6FE, 0xADB7, 0x641A, 0xADB7, 0x0000, 0x0077, 0x0078, 0x00C5, 0x0000, 0x0000, 0xFFFF, 0x0000, 0x0000, 
    /*0x00E0*/ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xADB7, 0x550E, 0x6729, 0x560E, 0x0090, 0x8DA0, 0xB507, 0xDE02, 0x540E, 
    /*0x0100*/ 0x8E02, 0x740E, 0xFD47, 0x7518, 0x8DA1, 0x7518, 0x0000, 0x8DA0, 0xB507, 0xDE02, 0x540E, 0x8E02, 0x740E, 0xFD47, 0x7518, 0x8DA1, 
    /*0x0120*/ 0x7518, 0x0000, 0x8DA0, 0xB507, 0xDE02, 0x540E, 0x8E02, 0x740E, 0xFD47, 0x7518, 0x8DA1, 0x7518, 0x0000, 0x8DA0, 0xB507, 0xDE02, 
    /*0x0140*/ 0x540E, 0x8E02, 0x740E, 0xFD47, 0x7518, 0x8DA1, 0x7518, 0x540E, 0x0000, 0xB507, 0x8DA1, 0x7518, 0xFD47, 0x2712, 0xAE01, 0x8E01, 
    /*0x0160*/ 0x8201, 0x7518, 0x0C76, 0x540E, 0x0000, 0xB507, 0x8DA1, 0x7518, 0xFD47, 0x2712, 0xAE01, 0x8E01, 0x8201, 0x7518, 0x0C75, 0x4729, 
    /*0x0180*/ 0x760E, 0x652D, 0x0000, 0x0C6D, 0xADB7, 0xADB7
};
...
//  cfg         input       output      state       
    0x00000000, 0x00000000, 0x002010EA, 0x00000000  // spi for launchpad
};
...
static void scifTaskResourceInit(void) {
    scifInitIo(6, (AUXIOMODE_OUTPUT * (0 == 0)) + (AUXIOMODE_OPEN_DRAIN * (0 == 1)), (0 == 1) - (0 == 0), 1);
    scifInitIo(5, AUXIOMODE_OUTPUT,     -1, 0);
    scifInitIo(4, AUXIOMODE_OUTPUT,     -1, 0);
    scifInitIo(3, AUXIOMODE_INPUT_IDLE, -1, 0);
...
void scifReinitTaskIo(uint32_t bvTaskIds) {
    if (bvTaskIds & (1 << SCIF_SPI_FOR_LAUNCHPAD_TASK_ID)) {
        scifReinitIo(6, 1);
        scifReinitIo(5, -1);
        scifReinitIo(4, -1);
        scifReinitIo(3, -1);
...
// Generated by CHENFEI-PC at 2017-11-27 11:58:25.612
