...
static const uint16_t pAuxRamImage[] = {
    ...
    /*0x00C0*/ 0x6436, 0xBDB7, 0x241A, 0xA6FE, 0xADB7, 0x641A, 0xADB7, 0x0000, 0x0077, 0x007A, 0x008F, 0x0000, 0x0000, 0xFFFF, 0x0000, 0x0000, 
    /*0x00E0*/ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0001, 0x0C67, 0xADB7, 0x0876, 0x8C01, 0xB602, 0x650F, 0x0480, 0x450F, 
    /*0x0100*/ 0x0876, 0x8801, 0x0C76, 0x0876, 0x8C0F, 0xBE06, 0x0876, 0x8DAC, 0x0C75, 0x086C, 0x8201, 0x0C6C, 0x0001, 0x0C67, 0xADB7, 0xADB7
};
...
//  cfg         input       output      state       
    0x00000000, 0x00000000, 0x001010EA, 0x001010EC  // LED Blinker
};
