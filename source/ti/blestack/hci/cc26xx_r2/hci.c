...
#if defined( CC26XX ) || defined( CC13XX )
  #if defined(CTRL_V42_CONFIG) && (CTRL_V42_CONFIG & (EXT_DATA_LEN_CFG | SECURE_CONNS_CFG | PRIVACY_1_2_CFG))
    #define HCI_VERSION                              0x08    // BT Core Specification V4.2
  #else // !(EXT_DATA_LEN_CFG | PRIVACY_1_2_CFG | SECURE_CONNS_CFG)
    #define HCI_VERSION                              0x07    // BT Core Specification V4.1
  #endif // (EXT_DATA_LEN_CFG | PRIVACY_1_2_CFG | SECURE_CONNS_CFG)
#else // !CC26XX
...
#if defined( CC26X2 )
#define HCI_REVISION                                 0x0300  // HCI Version 3.3.0
#elif defined( CC26XX ) || defined( CC13XX )
#define HCI_REVISION                                 0x0220  // HCI Version 2.2.0
#else // !CC26X2 & !CC26XX & !CC13XX
#define HCI_REVISION                                 0x0141  // HCI Version 1.4.1
#endif // CC26X2/CC26XX/CC13XX
...
#define SUPPORTED_CMD_RESERVED38                                                    0x02
#define SUPPORTED_CMD_RESERVED39                                                    0x04
#define SUPPORTED_CMD_RESERVED40                                                    0x08
#define SUPPORTED_CMD_RESERVED41                                                    0x10
#define SUPPORTED_CMD_RESERVED42                                                    0x20
#define SUPPORTED_CMD_RESERVED43                                                    0x40
#define SUPPORTED_CMD_RESERVED44                                                    0x80
...
#else // !SLV_FEAT_EXCHG_CFG
#define BYTE_27_ADV                                  (SUPPORTED_CMD_LE_READ_CHANNEL_MAP |                     \
                                                      SUPPORTED_CMD_LE_CONNECTION_UPDATE)
#endif // SLV_FEAT_EXCHG_CFG
...
#else // !PING_CFG
  #define SUPPORTED_COMMAND_BYTE_32                  (SUPPORTED_CMD_NONE)
#endif // PING_CFG
...
#if defined(CTRL_V42_CONFIG) && (CTRL_V42_CONFIG & EXT_DATA_LEN_CFG)
#define SUPPORTED_COMMAND_BYTE_33                    (SUPPORTED_CMD_SET_DATA_LENGTH                                               |  \
                                                      SUPPORTED_CMD_READ_SUGGESTED_DEFAULT_DATA_LENGTH)
#else // !EXT_DATA_LEN_CFG
#define SUPPORTED_COMMAND_BYTE_33                    (SUPPORTED_CMD_NONE)
#endif // EXT_DATA_LEN_CFG
#endif // MST_SLV_CFG
...
///////////////////////////////
  ...
  #if defined(CTRL_V42_CONFIG) && (CTRL_V42_CONFIG & SECURE_CONNS_CFG)
    #if defined(CTRL_V42_CONFIG) && (CTRL_V42_CONFIG & PRIVACY_1_2_CFG)
      #define SUPPORTED_COMMAND_BYTE_34              (SUPPORTED_CMD_LE_READ_LOCAL_P256_PUBLIC_KEY          | \
                                                      SUPPORTED_CMD_LE_GENERATE_DH_KEY                     | \
                                                      SUPPORTED_CMD_LE_ADD_DEVICE_TO_RESOLVING_LIST        | \
                                                      SUPPORTED_CMD_LE_REMOVE_DEVICE_FROM_RESOLVING_LIST   | \
                                                      SUPPORTED_CMD_LE_CLEAR_RESOLVING_LIST                | \
  ...
  #else // !SECURE_CONNS_CFG
    #if defined(CTRL_V42_CONFIG) && (CTRL_V42_CONFIG & PRIVACY_1_2_CFG)
      #define SUPPORTED_COMMAND_BYTE_34              (SUPPORTED_CMD_LE_ADD_DEVICE_TO_RESOLVING_LIST        | \
                                                      SUPPORTED_CMD_LE_REMOVE_DEVICE_FROM_RESOLVING_LIST   | \
                                                      SUPPORTED_CMD_LE_CLEAR_RESOLVING_LIST                | \
                                                      SUPPORTED_CMD_LE_READ_RESOLVING_LIST                 | \
                                                      SUPPORTED_CMD_LE_READ_PEER_RESOLVABLE_ADDRESS)
    #else // !PRIVACY_1_2_CFG
    #define SUPPORTED_COMMAND_BYTE_34                (SUPPORTED_CMD_NONE)
    #endif // PRIVACY_1_2_CFG
  #endif // SECURE_CONNS_CFG
#endif // EXT_DATA_LEN_CFG
...
///////////////////////////////
  ...
  #else // !PRIVACY_1_2_CFG
    #if defined(CTRL_V50_CONFIG) && (CTRL_V50_CONFIG & (PHY_2MBPS_CFG | PHY_LR_CFG))
      #define SUPPORTED_COMMAND_BYTE_35              (SUPPORTED_CMD_LE_READ_MAXIMUM_DATA_LENGTH               | \
                                                      SUPPORTED_CMD_LE_READ_PHY                               | \
                                                      SUPPORTED_CMD_LE_SET_DEFAULT_PHY                        | \
                                                      SUPPORTED_CMD_LE_SET_PHY                                | \
                                                      SUPPORTED_CMD_LE_ENHANCED_RECEIVER_TEST)
  ...
  #else // !PRIVACY_1_2_CFG
    #if defined(CTRL_V50_CONFIG) && (CTRL_V50_CONFIG & (PHY_2MBPS_CFG | PHY_LR_CFG))
      #define SUPPORTED_COMMAND_BYTE_35              (SUPPORTED_CMD_LE_READ_PHY                               | \
                                                      SUPPORTED_CMD_LE_SET_DEFAULT_PHY                        | \
                                                      SUPPORTED_CMD_LE_SET_PHY                                | \
                                                      SUPPORTED_CMD_LE_ENHANCED_RECEIVER_TEST)
    #else // !(PHY_2MBPS_CFG | PHY_LR_CFG)
      #define SUPPORTED_COMMAND_BYTE_35              (SUPPORTED_CMD_NONE)
    #endif // PHY_2MBPS_CFG | PHY_LR_CFG
  #endif // PRIVACY_1_2_CFG
#endif // EXT_DATA_LEN_CFG
...
hciStatus_t HCI_LE_SetEventMaskCmd( uint8 *pEventMask )
{
  ...
  if ( pEventMask != NULL )
  {
    ...
    // Note: So far, only the first two bytes are used.
    pBleEvtMask[0] = pEventMask[0];
    pBleEvtMask[1] = pEventMask[1];
...
#if defined( CC26XX ) || defined( CC13XX )
  // data packet length
  rtnParam[1] = LO_UINT16( maxPduSize );
  rtnParam[2] = HI_UINT16( maxPduSize );
                                    ...
                                    hciConnInfo_t *activeConnInfo )
{
       ...
       (activeConnInfo == NULL) )
  {
    ...
    if ( connInfo != NULL )
    {
      ...
      HCI_VendorSpecifcCommandCompleteEvent( HCI_EXT_GET_CONNECTION_INFO,
                                             size,
                                             connInfo );
...
hciStatus_t HCI_EXT_AdvEventNoticeCmd( uint8 taskID, uint16 taskEvent )
{
  ...
  status = MAP_LL_EXT_AdvEventNotice( taskID, taskEvent );

  MAP_HCI_CommandStatusEvent( status, HCI_EXT_ADV_EVENT_NOTICE );
...
hciStatus_t HCI_EXT_ScanEventNoticeCmd( uint8 taskID, uint16 taskEvent )
{
  ...
  status = MAP_LL_EXT_ScanEventNotice( taskID, taskEvent );

  MAP_HCI_CommandStatusEvent( status, HCI_EXT_SCAN_EVENT_NOTICE );
                                        ...
                                        uint16 taskEvent )
{
  ...
  status = MAP_LL_EXT_ConnEventNotice( connHandle, taskID, taskEvent );

  MAP_HCI_CommandStatusEvent( status, HCI_EXT_CONN_EVENT_NOTICE );
...
hciStatus_t HCI_EXT_ScanReqRptCmd( uint8 mode )
{
  ...
  rtnParam[0] = LO_UINT16( HCI_EXT_SCAN_REQ_REPORT_EVENT );
  rtnParam[1] = HI_UINT16( HCI_EXT_SCAN_REQ_REPORT_EVENT );

  rtnParam[2] = MAP_LL_EXT_ScanReqReport( mode );

  MAP_HCI_VendorSpecifcCommandCompleteEvent( HCI_EXT_SCAN_REQ_REPORT,
                                             sizeof(rtnParam),
                                             rtnParam );
