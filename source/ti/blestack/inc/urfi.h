...
#define UR_CMD_HANDLE_INVALID   RF_ALLOC_ERROR
...
/* RF driver handle */
extern RF_Handle    urHandle;
#if defined(FEATURE_ADVERTISER)
/* ADV command handle */
extern RF_CmdHandle urAdvHandle;
/* ADV command parameter */
extern rfc_bleAdvPar_t urAdvParams;
#endif /* FEATURE_ADVERTISER */

#if defined(FEATURE_SCANNER)
/* Scan command handle */
extern RF_CmdHandle urScanHandle;
/* Scan command parameter */
extern rfc_bleScannerPar_t urScanParams;
#endif /* FEATURE_SCANNER */

#if defined(FEATURE_MONITOR)
/* Monitor command handle */
extern RF_CmdHandle urGenericRxHandle;
/* Monitor command parameter */
extern rfc_bleGenericRxPar_t urGenericRxParams;
