 ...
 * @{
 * @brief These are set via @ref ub_setParameter
 */
/// @cond NODOC
...
/**
 * @brief Type of the callback to have @ref ub_processMsg called in the application
 * task context.
 *
 ...
 *             processed by @ref ub_processMsg in the application task context.
 ...
 *             the application task is activated it can call @ref ub_processMsg
