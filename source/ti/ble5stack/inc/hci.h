 ...
 * </tr>
 * <tr>
 *   <td>@ref HCI_LE_ReadPhyCmd</td>
 *   <td>LE Read PHY Command</td>
 *   <td>Y</td>
 * </tr>
 * <tr>
 ...
 * </tr>
 * <tr>
 *   <td>@ref HCI_LE_SetDefaultPhyCmd</td>
 *   <td>LE Set Default PHY Command</td>
 *   <td>Y</td>
 * </tr>
 * <tr>
 *   <td>@ref HCI_LE_SetPhyCmd</td>
 *   <td>LE Set PHY Command</td>
 *   <td>Y</td>
 * </tr>
 * <tr>
...
/** @defgroup DTM_TxPktCnt Tx Packet Params
 * @{
 */
...
/** @defgroup PHY_OPTS Phy Coded Options
 * @{
 */
#define HCI_PHY_OPT_NONE                                LL_PHY_OPT_NONE           //!< No Preferred Coding
#define HCI_PHY_OPT_S2                                  LL_PHY_OPT_S2             //!< S=2 Coding
#define HCI_PHY_OPT_S8                                  LL_PHY_OPT_S8             //!< S=8 Coding
/** @} End PHY_OPTS */

/** @defgroup CSA_Params Channel Selection Algorithm Params
 * @{
 */
#define HCI_CHANNEL_SELECT_ALGO_1                       LL_CHANNEL_SELECT_ALGO_1  //!< Channel Selection Algorithm #1
#define HCI_CHANNEL_SELECT_ALGO_2                       LL_CHANNEL_SELECT_ALGO_2  //!< Channel Selection ALgorithm #2
/** @} End CSA_Params */
 ...
 *
 *                              Set the Privacy Mode to either Network Privacy
 *              Mode or Device Privacy Mode. The Privacy Mode can be set for
 *              any peer in the Resolving List.
 *
 * @par         Corresponding Events
 ...
 *
 * See the <a href="../ble-stack/phy-2mbps.html">LE 2M PHY</a> section of the
 ...
 * @param       phyOpts    - Bit field of Host preferred PHY option(s) for @ref HCI_PHY_CODED.
 *                           See @ref PHY_OPTS
 *
 * @return      @ref HCI_SUCCESS
 */
...
/**
 * @brief       Set the DTM transmit packet count.
 *
 ...
 *
 * @param       txPktCnt - @ref DTM_TxPktCnt
 *
 * @return      @ref HCI_SUCCESS
 */
